...
//     }
//   }, [currentArticleSide?.images, frontCanvas, backCanvas]);
...
//     }
//   }, [currentArticleSide?.texts, dispatch, frontCanvas, backCanvas]);

//   // Export both sides on component mount and when canvas references change
//   useEffect(() => {
//     if (frontCanvas) {
//       const frontCanvasDataUrl = frontCanvas.toDataURL();
//       dispatch(canvasActions.setIsFrontSideExported(frontCanvasDataUrl));
//     }
//     if (backCanvas) {
//       const backCanvasDataUrl = backCanvas.toDataURL();
//       dispatch(canvasActions.setIsBackSideExported(backCanvasDataUrl));
//     }
//   }, [dispatch, currentArticle.active, frontCanvas, backCanvas]);
...
//     }
//   }, [currentArticleSide?.images, dispatch, frontCanvas, backCanvas]);
...
//     if (frontCanvas) {
//       addMainImageBg(frontCanvas, currentArticleSide?.src);
//     }
//     if (backCanvas) {
//       addMainImageBg(backCanvas, currentArticleSide?.src);
//     }
//   }, [
